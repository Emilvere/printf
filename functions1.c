...
********************/
/**
* print_unsigned number - prints unsigned num
* @types: arguments lists
* @buffer: buff array to handle print
...
********************/
/**
* print_octal - prints unsigned num
* in octal notation
...
* @size: size specifiers
* Return: Num of characterss printed
*/
...
****************/
/**
* print_hexadecimal - prints unsigned num
